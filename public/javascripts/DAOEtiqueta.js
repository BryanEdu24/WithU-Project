...
class DAOEtiqueta {
	...
	agregarEtiqueta(etiqueta, callback) { //Publicación debería ser una estructura {titulo, cuerpo}
		this._pool.getConnection(function(err, connection) {
			if (err) {
				...
				connection.query("INSERT INTO etiqueta (Nombre) VALUES (?)",  [ etiqueta ], //Aquí va la query a la BD
					function(err, result) {
						connection.release();
						if (err) {
