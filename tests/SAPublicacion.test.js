...
test('Intentamos agregar una publicación con titulo , cuerpo correctos y seccion correctas', done =>{
    function cb(err, ID){
        try{
    ...
    let publicacion = { titulo: tituloCorrecto, cuerpo: cuerpoCorrecto, seccion:seccionCorrecta};
    try{
        sa.agregarPublicacion(publicacion, cb);
    }catch(error){
        done(error);
...
test('Intentamos agregar una publicación con titulo , cuerpo correctos y seccion incorrectas', done =>{
    function cb(err, ID){
        try{
    ...
    let publicacion = { titulo: tituloCorrecto, cuerpo: cuerpoCorrecto,seccion:seccionIncorrecta};
    try{
        sa.agregarPublicacion(publicacion, cb);
    }catch(error){
        done(error);
...
test('Intentamos agregar una publicación con titulo , cuerpo correctos y seccion undefined', done =>{
    function cb(err, ID){
        try{
...
test('Intentamos agregar una publicación con titulo , cuerpo correctos y seccion null', done =>{
    function cb(err, ID){
        try{
            expect(err).toBe("No puede haber campos vacios");
            done();
    ...
    let publicacion = { titulo: tituloCorrecto, cuerpo: cuerpoCorrecto,seccion:null};
    try{
        sa.agregarPublicacion(publicacion, cb);
    }catch(error){
        done(error);
